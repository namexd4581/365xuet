...
<div style="padding-top: 50px;background: #ececec; width:100% ;height:500px">
    ...
    <div class="mystudy">
        <ul >
            ...
            <li><a href="/index.php/weixin/User/studentlessons">我的课程表</a></li>
            <li><a href="/index.php/weixin/User/jiafang">入驻家访</a></li>
            <li><a href="/index.php/weixin/User/evaluate">我的评价</a></li>
            <li><a href="/index.php/weixin/User/favorite">我的收藏</a></li>
        </ul>
