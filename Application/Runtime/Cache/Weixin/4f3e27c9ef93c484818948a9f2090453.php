...
<div style="padding-top: 50px;background: #ececec; width:100% ;height:550px">
    <div style="background: orange;width: 100%;height: 90px;">
        <div style="text-align: left;padding-left: 0px;padding-top: 10px;float: left">
            <ul style="padding-left: 5px">
                <li><img src="/weixin/Public/Weixin/images/1015.png" height="50px"  alt=""></li>
    ...
    <div class="mystudy">
        <ul >
            <li style="border:1px solid #ececec;width: 100%;text-align: left;font-size: 1em;padding-left: 5px;height: 40px" >我的学习</li>
            <li><a href="<?php echo U('Student/studentlessons');?>">我的课程表</a></li>
            <li><a href="<?php echo U('Student/jiafang');?>">入驻家访</a></li>
            <li><a href="<?php echo U('Student/evaluate');?>">我的评价</a></li>
            <li><a href="<?php echo U('Student/favorite');?>">我的收藏</a></li>
        </ul>
    ...
    <div class="money">
        <ul>
            ...
            <li><a href="<?php echo U('Student/money');?>">账户余额</a></li>
            <li><a href="<?php echo U('Student/order');?>">我的订单</a></li>
        </ul>
    ...
    <div class="setting">
        <ul>
            ...
            <a href="<?php echo U('Student/personalset');?>"><li>个人设置</li></a>
            <a href="<?php echo U('Student/setting');?>"><li>安全设置</li></a>
        </ul>
    </div>
