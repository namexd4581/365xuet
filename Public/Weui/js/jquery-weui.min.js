 ...
 * Licensed under the MIT license */
    function (t, e, n, i) {
        ...
        function b(t, e, n) {
            var i = n.pointers.length, a = n.changedPointers.length, r = e & Pt && i - a === 0, o = e & (St | Ht) && i - a === 0;
        ...
        function M(t, e) {
            ...
            e.timeStamp = gt(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = I(s, c), e.distance = H(s, c), E(n, e), e.offsetDirection = S(e.deltaX, e.deltaY);
        ...
        function D(t, e) {
            ...
            if (e.eventType != Ht && (c > Ot || s.velocity === i)) {
                ...
                a = p.x, r = p.y, n = vt(p.x) > vt(p.y) ? p.x : p.y, o = S(l, u), t.lastInterval = e
        ...
        function z(t, e) {
            ...
            return e & (St | Ht) && (n = y(n.concat(i), "identifier", !0)), [n, i]
        }
        ...
        function R(t, e) {
            ...
            for (a = 0; a < o.length;)i[o[a].identifier] && s.push(o[a]), e & (St | Ht) && delete i[o[a].identifier], a++;
        ...
        var wt = s(function (t, e, n) {
            ...
            return wt(t, e, !0)
        }, "merge", "Use `assign`."), Tt = 1, kt = /mobile|tablet|ip(ad|hone|od)|android/i, xt = "ontouchstart" in t, _t = T(t, "PointerEvent") !== i, Ct = xt && kt.test(navigator.userAgent), bt = "touch", Mt = "pen", Et = "mouse", Dt = "kinect", Ot = 25, Pt = 1, At = 2, St = 4, Ht = 8, It = 1, Yt = 2, Vt = 4, Nt = 8, Ft = 16, qt = Yt | Vt, zt = Nt | Ft, Lt = qt | zt, Rt = ["x", "y"], jt = ["clientX", "clientY"];
        _.prototype = {
            handler: function () {
            }, init: function () {
        ...
        var Xt = {mousedown: Pt, mousemove: At, mouseup: St}, $t = "mousedown", Wt = "mousemove mouseup";
        c(N, _, {
            handler: function (t) {
                var e = Xt[t.type];
                e & Pt && 0 === t.button && (this.pressed = !0), e & At && 1 !== t.which && (e = St), this.pressed && (e & St && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: Et,
                    srcEvent: t
        ...
        var Kt = {pointerdown: Pt, pointermove: At, pointerup: St, pointercancel: Ht, pointerout: Ht}, Ut = {
            2: bt,
            3: Mt,
            4: Et,
            5: Dt
        }, Bt = "pointerdown", Gt = "pointermove pointerup pointercancel";
        t.MSPointerEvent && !t.PointerEvent && (Bt = "MSPointerDown", Gt = "MSPointerMove MSPointerUp MSPointerCancel"), c(F, _, {
            handler: function (t) {
                var e = this.store, n = !1, i = t.type.toLowerCase().replace("ms", ""), a = Kt[i], r = Ut[t.pointerType] || t.pointerType, o = r == bt, s = g(e, t.pointerId, "pointerId");
                a & Pt && (0 === t.button || o) ? 0 > s && (e.push(t), s = e.length - 1) : a & (St | Ht) && (n = !0), 0 > s || (e[s] = t, this.callback(this.manager, a, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: r,
                    srcEvent: t
        ...
        var Jt = {
            ...
            touchend: St,
            touchcancel: Ht
        }, Zt = "touchstart", Qt = "touchstart touchmove touchend touchcancel";
        c(q, _, {
            handler: function (t) {
                var e = Jt[t.type];
                if (e === Pt && (this.started = !0), this.started) {
                    var n = z.call(this, t, e);
                    e & (St | Ht) && n[0].length - n[1].length === 0 && (this.started = !1), this.callback(this.manager, e, {
                        pointers: n[0],
                        changedPointers: n[1],
                        pointerType: bt,
                        srcEvent: t
        ...
        c(j, _, {
            handler: function (t, e, n) {
                var i = n.pointerType == bt, a = n.pointerType == Et;
        ...
        G.prototype = {
            ...
            directionTest: function (t) {
                ...
                return a & e.direction || (e.direction & qt ? (a = 0 === r ? It : 0 > r ? Yt : Vt, n = r != this.pX, i = Math.abs(t.deltaX)) : (a = 0 === o ? It : 0 > o ? Nt : Ft, n = o != this.pY, i = Math.abs(t.deltaY))), t.direction = a, n && i > e.threshold && a & e.direction
            },
            attrTest: function (t) {
            ...
            defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
                ...
                if (this._input = t, !i || !n || t.eventType & (St | Ht) && !r)this.reset(); else if (t.eventType & Pt)this.reset(), this._timer = a(function () {
                    this.state = ge, this.tryEmit()
                }, e.time, this); else if (t.eventType & St)return ge;
                return ye
            }, reset: function () {
            ...
            attrTest: function (t) {
                ...
                return n & (qt | zt) ? e = t.overallVelocity : n & qt ? e = t.overallVelocityX : n & zt && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && n & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && vt(e) > this.options.velocity && t.eventType & St
            },
            emit: function (t) {
    ...
    t.modal = function (n, i) {
        ...
        }).join(""), o = '<div class="weui_dialog"><div class="weui_dialog_hd"><strong class="weui_dialog_title">' + n.title + "</strong></div>" + (n.text ? '<div class="weui_dialog_bd">' + n.text + "</div>" : "") + '<div class="weui_dialog_ft">' + r + "</div></div>", s = t.openModal(o, i);
    ...
    var e = function (e, n) {
        n = n || "";
        var i = (t("<div class='weui_mask_transparent'></div>").appendTo(document.body), '<div class="weui_toast ' + n + '">' + e + "</div>"), a = t(i).appendTo(document.body);
    ...
    "use strict";
    var e, n = function (e) {
        var n = t("<div class='weui_mask weui_actions_mask'></div>").appendTo(document.body), i = e.actions || [], a = i.map(function (t, e) {
            return '<div class="weui_actionsheet_cell ' + (t.className || "") + '">' + t.text + "</div>"
        }).join(""), r = "";
        e.title && (r = '<div class="weui_actionsheet_title">' + e.title + "</div>");
        var o = '<div class="weui_actionsheet " id="weui_actionsheet">' + r + '<div class="weui_actionsheet_menu">' + a + '</div><div class="weui_actionsheet_action"><div class="weui_actionsheet_cell weui_actionsheet_cancel">取消</div></div></div>', s = t(o).appendTo(document.body);
    ...
    "use strict";
    var e = "weui_bar_item_on", n = function (n) {
        var i = t(n);
        if (!i.hasClass(e)) {
            var a = i.attr("href");
            if (/^#/.test(a)) {
    ...
    n.prototype.initConfig = function () {
        ...
        if (!this._open) {
            this.parseInitValue();
            var i = this.config, a = this.dialog = t.openPicker(this.getHTML(), t.proxy(this.onClose, this));
    ...
    var e, n = !1, i = function (i) {
        ...
        function s(t) {
            if (t.preventDefault(), !u.opened && (u.open(), u.params.scrollToInput && !a())) {
                ...
                if (0 === e.length)return;
                var n, i = parseInt(e.css("padding-top"), 10), r = parseInt(e.css("padding-bottom"), 10), o = e[0].offsetHeight - i - u.container.height(), s = e[0].scrollHeight - i - u.container.height(), c = u.input.offset().top - i + u.input[0].offsetHeight;
                if (c > o) {
        ...
        return u.animating = !1, u.addValue = function (t) {
            ...
            function r(e) {
                if (_) {
                    ...
                    if (0 === n.length && t(e.target).hasClass("picker-calendar-day") && (n = t(e.target)), 0 !== n.length && (!n.hasClass("picker-calendar-day-selected") || u.params.multiple) && !n.hasClass("picker-calendar-day-disabled")) {
                        ...
                        u.params.onDayClick && u.params.onDayClick(u, n[0], i, a, r), u.addValue(new Date(i, a, r).getTime()), u.params.closeOnSelect && u.close()
                    }
                }
            }
            ...
            var a = u.daysInMonth(new Date(t.getFullYear(), t.getMonth()).getTime() - 864e6), r = u.daysInMonth(t), o = new Date(t.getFullYear(), t.getMonth()).getDay();
            0 === o && (o = 7);
            var s, c, l, p = [], h = 6, d = 7, f = "", m = 0 + (u.params.firstDay - 1), v = (new Date).setHours(0, 0, 0, 0), g = u.params.minDate ? new Date(u.params.minDate).getTime() : null, w = u.params.maxDate ? new Date(u.params.maxDate).getTime() : null;
            ...
            for (c = 1; h >= c; c++) {
                ...
                for (l = 1; d >= l; l++) {
                    ...
                    var _ = s.getFullYear(), C = s.getMonth();
            ...
            var e = 100 * -(t + 1) * h, n = 100 * -t * h, i = 100 * -(t - 1) * h;
            ...
            var n = parseInt(u.months.eq(u.months.length - 1).attr("data-month"), 10), i = parseInt(u.months.eq(u.months.length - 1).attr("data-year"), 10), a = new Date(i, n), r = a.getTime(), o = !u.animating;
            if (u.params.maxDate && r > new Date(u.params.maxDate).getTime())return u.resetMonth();
            if (u.monthsTranslate--, n === u.currentMonth) {
                var s = 100 * -u.monthsTranslate * h, c = t(u.monthHTML(r, "next")).transform("translate3d(" + (u.isH ? s : 0) + "%, " + (u.isH ? 0 : s) + "%, 0)").addClass("picker-calendar-month-next");
            ...
            "undefined" != typeof e && "object" != typeof e || (e = "", u.params.animate || (e = 0));
            var n = parseInt(u.months.eq(0).attr("data-month"), 10), i = parseInt(u.months.eq(0).attr("data-year"), 10), a = new Date(i, n + 1, -1), r = a.getTime(), o = !u.animating;
            if (u.params.minDate && r < new Date(u.params.minDate).getTime())return u.resetMonth();
            if (u.monthsTranslate++, n === u.currentMonth) {
                var s = 100 * -u.monthsTranslate * h, c = t(u.monthHTML(r, "prev")).transform("translate3d(" + (u.isH ? s : 0) + "%, " + (u.isH ? 0 : s) + "%, 0)").addClass("picker-calendar-month-prev");
            ...
            var a = new Date(u.currentYear, u.currentMonth).getTime(), r = i > a ? "next" : "prev", o = u.monthHTML(new Date(t, e));
            u.monthsTranslate = u.monthsTranslate || 0;
            var s, c, l = u.monthsTranslate, p = !u.animating;
            ...
            var t, e = "", n = "", i = u.value && u.value.length ? u.value[0] : (new Date).setHours(0, 0, 0, 0), a = u.monthHTML(i, "prev"), r = u.monthHTML(i), o = u.monthHTML(i, "next"), s = '<div class="picker-calendar-months"><div class="picker-calendar-months-wrapper">' + (a + r + o) + "</div></div>", c = "";
            if (u.params.weekHeader) {
                for (t = 0; 7 > t; t++) {
                    var l = t + u.params.firstDay > 6 ? t - 7 + u.params.firstDay : t + u.params.firstDay, p = u.params.dayNamesShort[l];
    ...
    n.prototype = {
        getDays: function (t) {
            ...
            var e = this.params, n = t.split(e.dateTimeSplit), i = n[0], a = n[1];
            ...
            return n.setHours(t[3]), n.setMinutes(t[4]), n
        }, getConfig: function () {
            var t, e = new Date, n = this.params, i = this, a = {
                rotateEffect: !1,
                ...
                onChange: function (e, a, r) {
                    var o = e.cols, s = i.getDaysByMonthAndYear(o[1].value, o[0].value), c = e.cols[2].value;
                    c > s.length && (c = s.length), e.cols[2].setValue(c);
                    var l = i.arrayToDate(a), u = !0;
                    if (n.min) {
                        var p = i.arrayToDate(i.stringToArray("function" == typeof n.min ? n.min() : n.min));
                        +p > l && (e.setValue(t), u = !1)
                    }
                    if (n.max) {
            ...
            return r && (a.value = this.stringToArray(r)), this.params.value && (this.input.val(this.params.value), a.value = this.stringToArray(this.params.value)), a
        }
    }, t.fn.datetimePicker = function (i) {
        return i = t.extend({}, e, i), this.each(function () {
            if (this) {
                var e = t(this), a = e.data("datetime");
                return a || e.data("datetime", new n(this, i)), a
            }
        })
    ...
    t.toptip = function (n, i, a) {
        if (n) {
            ...
            var r = a ? "bg-" + a : "bg-danger", o = t(".weui_toptips").remove();
